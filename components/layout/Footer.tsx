        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <p className="text-sm text-gray-600 font-medium">
              &copy; {new Date().getFullYear()} BlueSky Parcel OÜ {t("footer.allRightsReserved")}
            </p>
            ...
            <div className="flex items-center gap-2 px-3 py-1 bg-white rounded-full border border-gray-200 shadow-sm">
              ...
              <Link
                ...
                className="text-xs font-semibold text-[#1f94d3] hover:text-[#4a9bc9] transition-colors duration-200"
                target="_blank"
          ...
          <nav className="flex gap-6">
            <Link
              ...
              className="text-sm text-gray-600 hover:text-[#1f94d3] hover:underline underline-offset-4 transition-colors duration-200"
              target="_blank"
              rel="noopener noreferrer"
            >
