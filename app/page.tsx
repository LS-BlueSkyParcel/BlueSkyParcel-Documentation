...
--data '{
  ...
  },
  {
    ...
    parameters: ["transportNumber", "packageId", "parcelId", "recipient_info", "sender_info", "item_details"],
    queryParams: [
      {
        name: "ls",
        values: "Y, N",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div style={{ paddingTop: "50px" }}>
        {/* Hero Section */}
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-br from-[#1f94d3]/10 via-[#1f94d3]/20 to-background">
          <div className="container px-4 md:px-6">
            <div className="text-center space-y-4 max-w-4xl mx-auto">
              <div className="flex justify-center mb-6">
                <div className="p-3 rounded-full" style={{ backgroundColor: "#1f94d320" }}>
                  <Code className="h-8 w-8" style={{ color: "#1f94d3" }} />
                </div>
              </div>
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl" style={{ color: "#1f94d3" }}>
                {t("apiDocs.title")}
              </h1>
              <p className="mx-auto max-w-[800px] text-slate-700 text-lg md:text-xl">{t("apiDocs.subtitle")}</p>
              <div className="flex flex-wrap justify-center gap-2 mt-6">
                <Badge variant="default" className="text-sm" style={{ backgroundColor: "#1f94d3" }}>
        ...
        <section className="w-full py-12 md:py-24 bg-white">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 md:grid-cols-3 max-w-6xl mx-auto mb-12">
              <Card className="border-[#1f94d3]/30">
                <CardHeader>
                  <div className="flex items-center space-x-3">
                    <div className="p-2 rounded-lg" style={{ backgroundColor: "#1f94d320" }}>
                      <Key className="h-6 w-6" style={{ color: "#1f94d3" }} />
                    </div>
              ...
              <Card className="border-[#1f94d3]/30">
                <CardHeader>
                  <div className="flex items-center space-x-3">
                    <div className="p-2 rounded-lg" style={{ backgroundColor: "#1f94d320" }}>
                      <BookOpen className="h-6 w-6" style={{ color: "#1f94d3" }} />
                    </div>
              ...
              <Card className="border-[#1f94d3]/30">
                <CardHeader>
                  <div className="flex items-center space-x-3">
                    <div className="p-2 rounded-lg" style={{ backgroundColor: "#1f94d320" }}>
                      <Zap className="h-6 w-6" style={{ color: "#1f94d3" }} />
                    </div>
...
`}</code>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="max-w-6xl mx-auto space-y-6">
              {apiEndpoints.map((endpoint, idx) => {
                ...
                return (
                  <Card key={idx} className="border-[#1f94d3]/30">
                    <CardHeader
                      ...
                      <div className="flex items-center justify-between">
                        <CardTitle className="flex items-center space-x-3">
                          <Badge
                            ...
                            style={endpoint.method !== "GET" ? { backgroundColor: "#1f94d3" } : {}}
                          >
                            {endpoint.method}
                          </Badge>
        ...
        <section className="w-full py-12 md:py-24 bg-white">
          <div className="container px-4 md:px-6">
            ...
            <Card className="max-w-6xl mx-auto border-[#1f94d3]/30">
              <CardHeader>
                ...
                <div className="grid gap-2 max-h-96 overflow-y-auto">
                  {statusCodes.map((status, idx) => (
                    <div
                      ...
                      style={{ borderLeftColor: "#1f94d3" }}
                    >
                      <code className="font-mono text-sm font-semibold" style={{ color: "#1f94d3" }}>
                        {status.code}
                      </code>
        ...
        <section className="w-full py-12 md:py-24 bg-slate-50">
          <div className="container px-4 md:px-6">
            ...
            <Card className="max-w-4xl mx-auto border-[#1f94d3]/30">
              <CardHeader>
                <div className="flex items-center space-x-3">
                  <Shield className="h-6 w-6" style={{ color: "#1f94d3" }} />
...
--data '[{"waybill": "999-12345678", ...}]'`}</code>
                ...
                <div className="mt-4 p-4 rounded-lg" style={{ backgroundColor: "#1f94d310" }}>
                  <p className="text-sm" style={{ color: "#1f94d3" }}>
        ...
        <section className="w-full py-12 md:py-24 bg-white">
          <div className="container px-4 md:px-6">
            <div className="text-center space-y-6 max-w-2xl mx-auto">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl" style={{ color: "#1f94d3" }}>
                {t("apiDocs.additionalResources")}
              </h2>
              <p className="text-slate-700 md:text-lg">{t("apiDocs.everythingYouNeed")}</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" asChild className="text-white" style={{ backgroundColor: "#1f94d3" }}>
